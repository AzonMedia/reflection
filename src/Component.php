...
class Component extends BaseComponent
{
    ...
    protected const COMPONENT_NAME = "Reflection package";
    protected const COMPONENT_URL = 'https://reflection.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/reflection/docs/ErrorReference/';
}